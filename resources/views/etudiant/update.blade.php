...
<html lang="en">
  ...
  <body>
    ...
    <div class="col s12">
        <h1>MODIFIER UN ETUDIANT - TP-4-LARAVEL</h1>
        <hr>
        ...
        <input type="text" name="id" style="display: none;" value="{{$etudiants->id}}">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="Classe" name="cla.sse" value="{{$etudiants->classe}}">
              </div>
              <div class="form-group">
              ...
              <div class="form-floating">
                ...
                <div class="form-floating">
                  ...
                  <div class="form-floating">
                    <div><label for="groupe_sanguin" class="form-label">Groupe_sanguin</label></div>
                    <select class="form-select" id="groupe_sanguin" aria-label="Floating label select example" name="groupe_sanguin">
                    @foreach($groupes_saguin as $groupe_sanguin)
